...
import { BookOpen, Play, CheckCircle2, Star, Clock, Lock } from 'lucide-react';
            ...
            <div className="aspect-[21/9] relative overflow-hidden">
              ...
              <div className="absolute bottom-6 left-8">
                <div className="bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest text-white border border-white/10">
                  {course.total_xp_available} XP available
                </div>
              </div>
            </div>
                    ...
                    <div className="space-y-2">
                      {unit.lessons?.map((lesson: any) => (
                        ...
                        >
                          ...
                          <span className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">+{lesson.xp_reward} XP</span>
                        </button>
                      ))}
                    </div>
                  </div>
