            ...
            >
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">level {goal.level}</p>
                  <p className="text-[10px] font-bold text-white uppercase tracking-widest">{goal.xp} xp</p>
                </div>
              </div>
